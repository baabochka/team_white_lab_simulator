...
equipmentList = [
    {"name": "Micropipette", "description": "Tool to pick and drop small amount of liquid", "state": "state",
     "materials": [m_id1, m_id2]},
    {"name": "Beaker", "description": "Glass container graduated with lines indicating the volume contained",
     "state": "state", "materials": [m_id1, m_id2]},
]
...
collection = mydb.Lab
labList = [
    {"name": "Lab 1", "description": "Mix water and H2SO4", "professors": [id1], "steps": [],
     "equipments": [e_id1, e_id2]},
]
...
courseList = [
    ...
    {"name": "CSE303", "description": "Introduction to the Theory of Computation", "professors": [id2],
     "labs": [l_id1]},
